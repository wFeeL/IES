...
GLOSSARY_GROUPS: List[Dict[str, Any]] = [
    ...
    {
        "title": "Режимы анализа",
        "items": [
            ("forecast", "анализ по загруженному прогнозу"),
            ("no_forecast", "анализ по ручному коридору неопределённости"),
        ],
    },
]
