...
- Отдельного compare-flow нет: решение принимается по таблице лотов и детальной аналитике конкретного лота.
- История оценок хранится технически, но не является частью основного пользовательского UX.
